...
class _TasbeehScreenState extends State<TasbeehScreen> with AutomaticKeepAliveClientMixin {
  ...
  // دالة الإحصائيات بشكل مطابق للشعار العلوي
  void showTotalStats() {
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: boxColor,
                    borderRadius: BorderRadius.circular(30), // نفس شكل الشعار العلوي
          ...
          builder: (context, scrollController) {
            return Stack(
              children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        padding: const EdgeInsets.only(top: 12, left: 12, right: 12, bottom: 80), // مساحة عشان الزرار تحت
                        itemCount: dhikrList.length,
                        itemBuilder: (context, index) {
                ...
                // زر الإضافة تحت على اليمين بنفس شكل الشعار العلوي بالظبط
                Positioned(
                  bottom: 20,
                  right: 20,
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // التعديل هنا: ضغطة واحدة تصفير، ضغطة مطولة إحصائيات
            GestureDetector(
              onTap: () {
